...
interface ProgressPageProps { notice?: string; onMealPlan(): void; onChat(): void; onProfile(): void; onLogout(): void }
export function ProgressPage({ notice, onMealPlan, onChat, onProfile, onLogout }: ProgressPageProps) {
